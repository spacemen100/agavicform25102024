...
const BesoinEpargne: React.FC = () => {
    ...
    return (
        <ChakraProvider theme={theme}>
            <StepperWithSubStepCounter currentStep={1} currentSubStep={15} totalSubSteps={24} title="Pourriez-vous avoir besoin de toute l'épargne placée chez Yomoni d'ici 2 ans ?" />
            <Box p={5} maxW="1000px" mx="auto">
                <Text fontSize="xl" fontWeight="bold" mb={5} textAlign="center">
                    Pourriez-vous avoir besoin de toute l'épargne placée chez Yomoni d'ici 2 ans ?
                </Text>
